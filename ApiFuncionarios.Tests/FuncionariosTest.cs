...
namespace ApiFuncionarios.Tests
{
    ...
    public class FuncionariosTest
    {
        ...
        public async Task<ResultadoFuncionario> PostFuncionario()
        {
            ...
            var request = new ContatoPostRequest()
            {
        ...
        public async Task<ResultadoFuncionario> PutFuncionario()
        {
            ...
            var request = new ContatoPutRequest()
            {
        ...
        /// </summary>
        [Fact]
        public async Task<List<Contato>> GetAllFuncionarios()
        {
            //realizar o cadastro de um funcionário
            ...
            //capturar o resultado obtido
            var resultado = JsonConvert.DeserializeObject<List<Contato>>
                (response.Content.ReadAsStringAsync().Result);
        ...
        /// </summary>
        [Fact]
        public async Task<Contato> GetFuncionarioById()
        {
            //realizar o cadastro de um funcionário
            var cadastro = await PostFuncionario();
            ...
            //capturar o resultado obtido
            var resultado = JsonConvert.DeserializeObject<Contato>
                (response.Content.ReadAsStringAsync().Result);
    ...
    public class ResultadoFuncionario
    {
        ...
        public Contato funcionario { get; set; }
    }
}